...
- Think of the histogram on the previous slide as showing data for measurements of human heights in inches.  
...
--
  ...
  3) We repeat steps 1 & 2 a very large number of times, say 1,000. 
...
- Here is a histogram of the data we obtained from the game described on teh previous slide:
...
- The mean of our data is `r round(mean(ms),2)`. What is the expected value of a binomial random variable with $n=25$ and $p=0.5$? 