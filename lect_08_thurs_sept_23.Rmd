...
- The variance of a sampling distribution is called **standard error**. 

--

- For example, the variance of the sampling proportion $\hat{p}$ would be the standard error for $\hat{p}$. By the central limit theorem, the standard error for $\hat{p}$ is (very nearly)
