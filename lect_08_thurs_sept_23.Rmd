...
- Failing to reject the null hypothesis only means that the evidence we have collected just not provide sufficient support for rejecting the null hypothesis. 
