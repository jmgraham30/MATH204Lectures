...
- In some cases, there is a [**nonparametric**](https://en.wikipedia.org/wiki/Nonparametric_statistics) parallel to the inferential methods we have studied so far that allow us to weaken the conditions say for conducting a hypothesis test. 

--

- We cover some of these nonparametric statistics in this lecture. Note that this material is not covered in out textbook [OpenIntro Statistics](https://openintro.org/book/os/). 
...
- Below we list some inferential methods we have already studies together with their parallel nonparametric test.
...
--
  ...
  - $H_{A}:$ There is a difference in the length of workout session. 
