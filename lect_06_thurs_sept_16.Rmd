...
- In this class, we will not need to compute the variance for random variables by hand. However, it is helpful to know that if $a$ and $b$ are numbers and if $X$ is a random variable, then
