...
Recall from last lecture, we introduced data, data collection and sampling strategies, and the structure of data and variable types. 
...
- In this lecture, we describe the next step the research process 
...
- It is important to note that the type of a variable will determine the kind of graphical or numeric summary that is used.  
...
In section 2.1, the text also discusses the `epa2021` data set. In the R console, run the following commands to learn about this data. 
...
3. Using the `mean` function in R
...
- **Question:** In what sense does the sample median of the `interest_rate` data measure the center of the distribution of the sample data? How much to "large" values contribute to the mean?
...
Not always true, but often about 70% of data lie within one standard deviation of the mean and about 96% of data lie within two standard deviations of the mean. 
