...
- One of the main benefits of using adjusted $R^2$ for multiple regression is that it accounts for **model complexity**. Complex models are more likely to overfit. 
