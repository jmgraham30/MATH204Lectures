...
- When the conditions for the CLT for the sample mean hold, the expression for the standard error involves the population standard deviation which we rarely know if practice. So, how do we estimate the standard error for the sample mean? 
